...
struct rxe_opcode_info rxe_opcode[RXE_NUM_OPCODE] = {
	...
	[IB_OPCODE_RC_RDMA_WRITE_FIRST] = {
		...
		.length = RXE_BTH_BYTES + RXE_RETH_BYTES + TIMELY_TIMESTAMP_SIZE,
		.offset = {
			[RXE_BTH] = 0,
			[RXE_RETH] = RXE_BTH_BYTES,
			[RXE_TIMELY_TIMESTAMP] = RXE_BTH_BYTES
						+ RXE_RETH_BYTES,
			[RXE_PAYLOAD] = RXE_BTH_BYTES
						+ RXE_RETH_BYTES + TIMELY_TIMESTAMP_SIZE,
		}
	},
	[IB_OPCODE_RC_RDMA_WRITE_MIDDLE] = {
		...
		.mask = RXE_PAYLOAD_MASK | RXE_REQ_MASK | RXE_WRITE_MASK
				| RXE_MIDDLE_MASK,
		.length = RXE_BTH_BYTES + TIMELY_TIMESTAMP_SIZE,
		.offset = {
			[RXE_BTH] = 0,
			[RXE_TIMELY_TIMESTAMP] = RXE_BTH_BYTES,
			[RXE_PAYLOAD] = RXE_BTH_BYTES + TIMELY_TIMESTAMP_SIZE,
		}
	},
	...
	[IB_OPCODE_RC_RDMA_WRITE_LAST_WITH_IMMEDIATE] = {
		...
		.mask = RXE_IMMDT_MASK | RXE_PAYLOAD_MASK | RXE_REQ_MASK
				...
				| RXE_END_MASK,
		.length = RXE_BTH_BYTES + RXE_IMMDT_BYTES + TIMELY_TIMESTAMP_SIZE,
		.offset = {
			[RXE_BTH] = 0,
			[RXE_IMMDT] = RXE_BTH_BYTES,
			[RXE_TIMELY_TIMESTAMP] = RXE_BTH_BYTES + RXE_IMMDT_BYTES,
			[RXE_PAYLOAD] = RXE_BTH_BYTES
						+ RXE_IMMDT_BYTES + TIMELY_TIMESTAMP_SIZE,
		}
	},
	[IB_OPCODE_RC_RDMA_WRITE_ONLY] = {
		...
		.offset = {
			[RXE_BTH] = 0,
			[RXE_RETH] = RXE_BTH_BYTES,
			[RXE_TIMELY_TIMESTAMP] = RXE_BTH_BYTES + RXE_RETH_BYTES,
			[RXE_PAYLOAD] = RXE_BTH_BYTES
						+ RXE_RETH_BYTES + TIMELY_TIMESTAMP_SIZE,
		}
	},
	[IB_OPCODE_RC_RDMA_WRITE_ONLY_WITH_IMMEDIATE] = {
		...
		.mask = RXE_RETH_MASK | RXE_IMMDT_MASK | RXE_PAYLOAD_MASK
				...
				| RXE_START_MASK | RXE_END_MASK,
		.length = RXE_BTH_BYTES + RXE_IMMDT_BYTES + RXE_RETH_BYTES + TIMELY_TIMESTAMP_SIZE,
		.offset = {
			[RXE_BTH] = 0,
			[RXE_RETH] = RXE_BTH_BYTES,
			[RXE_IMMDT] = RXE_BTH_BYTES
	...
	[IB_OPCODE_RC_ACKNOWLEDGE] = {
		...
		.mask = RXE_AETH_MASK | RXE_ACK_MASK | RXE_START_MASK
				| RXE_END_MASK,
		.length = RXE_BTH_BYTES + RXE_AETH_BYTES + TIMELY_TIMESTAMP_SIZE, // used for timestamp
		.offset = {
			[RXE_BTH] = 0,
			[RXE_AETH] = RXE_BTH_BYTES,
			[RXE_TIMELY_TIMESTAMP] = RXE_BTH_BYTES + RXE_AETH_BYTES,
			[RXE_PAYLOAD] = RXE_BTH_BYTES
						+ RXE_AETH_BYTES + TIMELY_TIMESTAMP_SIZE,
		}
	},
#else
	[IB_OPCODE_RC_RDMA_WRITE_FIRST] = {
